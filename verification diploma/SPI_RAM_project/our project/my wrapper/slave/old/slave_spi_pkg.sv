package spi_slave_pkg;
  ...
  // ==========================================================================
     ...
     class spi_slave_agent extends uvm_agent;
        ...
        // Only build driver and sequencer if not passive
        if (!is_passive) begin
        ...
        // Connect monitor's RAM port to agent's RAM port
        mon.ram_tx_ap.connect(ram_tx_ap);
        ...
        function void set_passive(bit passive);
        is_passive = passive;
        endfunction
