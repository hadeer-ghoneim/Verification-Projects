...
class sequnce_ram_item extends uvm_sequence_item;
        ...
        parameter bit [1:0] WRITE_ADDR = 2'b00;
        parameter bit [1:0] WRITE_DATA = 2'b01;
        parameter bit [1:0] READ_ADDR  = 2'b10;
        parameter bit [1:0] READ_DATA  = 2'b11;
        ...
        constraint c_rx_valid_low_prob { rx_valid dist { 0 := 5, 1 := 95 };}
