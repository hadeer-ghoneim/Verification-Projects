...
assign if_slave.clk=DUT_wrapper.clk;
assign if_slave.MISO=DUT_wrapper.MISO;
assign if_slave.rx_data=DUT_wrapper.rx_data;
assign if_slave.rx_valid=DUT_wrapper.rx_valid;
...
assign if_ram.clk=DUT_wrapper.clk;
assign if_ram.dout=DUT_wrapper.tx_data;
assign if_ram.tx_valid=DUT_wrapper.tx_valid;
