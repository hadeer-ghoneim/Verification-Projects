...
class test_wrapper extends uvm_test;
    ...
    write_only_sequence wo_sequence;
    read_only_sequence ro_sequence;
    write_read_sequence wr_sequence;
    ...
    function void build_phase(uvm_phase phase);
        ...
        wo_sequence = write_only_sequence::type_id::create("wo_sequence", this);
        ro_sequence = read_only_sequence::type_id::create("ro_sequence", this);
        wr_sequence = write_read_sequence::type_id::create("wr_sequence", this);
        ...
        uvm_config_db#(config_slave)::set(this, "env_slaver.*", "GFG_slave", cfg_slave);
        uvm_config_db#(config_wrapper)::set(this, "env_wrapperr.*", "GFG", cfg_wrapper);
        uvm_config_db#(config_ram)::set(this, "env_ramm.*", "GFG_ram", cfg_ram);
