package ALSU_test_pkg;
  ...
  class ALSU_test extends uvm_test;
    ...
    task run_phase(uvm_phase phase);
      ...
      `uvm_info("run_phase", "Waiting for coverage collection...", UVM_LOW)
      #100; // Wait for coverage to capture last transactions
      `uvm_info("run_phase", "Coverage collection completed", UVM_LOW)
